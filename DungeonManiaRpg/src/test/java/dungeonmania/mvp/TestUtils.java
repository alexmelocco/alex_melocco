...
public class TestUtils {
    ...
    public static String getSecondItemId(DungeonResponse res, String itemType) {
        return TestUtils.getInventory(res, itemType).get(1).getId();
    }

    public static String getFirstId(DungeonResponse res, String itemType) {
        return TestUtils.getEntities(res, itemType).get(0).getId();
    }

    public static String getSecondId(DungeonResponse res, String itemType) {
        return TestUtils.getEntities(res, itemType).get(1).getId();
    }
